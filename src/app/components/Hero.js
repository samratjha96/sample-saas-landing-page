    ...
    <div className="text-white">
      <div className="max-w-[800px] mt-[-96px] w-full h-screen mx-auto text-center flex flex-col justify-center">
        ...
        <div className="flex justify-center items-center py-4">
          ...
          <span ref={element} className="md:text-5xl sm:text-4xl text-xl font-bold md:pl-4 pl-2" />
        </div>
        ...
        <button className="bg-accent-color w-[200px] rounded-md font-medium my-6 mx-auto py-3 text-black">Get Started</button>
      </div>
    </div>
  );
};
